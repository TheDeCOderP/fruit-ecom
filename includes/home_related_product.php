                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="single_product.php?status=singleproduct&&id=<?php echo $eight_pdt_form_ctg_one['pdt_id'] ?>" class="link-to-product">
                                                    <img src="admin/uploads/<?php echo $eight_pdt_form_ctg_one['pdt_img'] ?>" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>form_
